...
const Services = () => {
  ...
  const services = [
    {
      ...
      scale: "h-full lg:h-[20rem] my-auto"
    },
    {
      icon: LuMonitor,
      ...
      scale: "lg:scale-110 scale-100 z-10 shadow-lg shadow-[#1A1787]/50"
    },
    {
      icon: LuSettings,
  ...
  return (
    <section id="services" className="relative z-20 mx-6 mt-10 lg:mt-0 bottom-0 lg:bottom-30 bg-background">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-1 mb-10 md:mb-0 lg:grid-cols-3 gap-5 lg:gap-0">
          {services.map((service, index) => (
            <Card key={index} className={`relative group hover:shadow-card transition-smooth rounded-xs border-0 bg-white ${service.scale}`}>
              <CardHeader className="text-center pb-4">
                <div className="w-12 h-12 md:w-16 md:h-16 mx-auto mb-4 bg-[#1A1787] rounded-2xl flex items-center justify-center group-hover:scale-110 transition-bounce">
