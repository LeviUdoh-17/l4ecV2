...
const Footer = () => {
  ...
  return (
    <div>
      <footer class="bg-slate-900 flex justify-between md:px-30 py-10 lg:gap-0 lg:flex-row flex-col gap-7 px-5">
        <div class="flex items-start gap-2">
          <img src="/logo.png" alt="Logo" class="w-[4rem]" />
          <p class="flex justify-center items-center flex-col mt-1 font-bold text-sky-400">
            ENTERPRISE <span class="font-normal text-xs">CONSULTING LLC</span>
          </p>
        </div>
        <div class="text-sky-400 flex justify-around items-center gap-7">
          <svg
